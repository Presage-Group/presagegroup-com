@def author = "Piyush Ghandi"
@def date = "2025-12-03"
@def tags = ["news", "UWAS"]
@def title = "Presage Group Joins UWaterloo Aviation Society for Industry Presentation"
@def short_text = "A discussion on career growth, preparedness, and advancing inclusion in aviation"
@def rss_pubdate = Date(2025, 12, 03)
@def img = "/assets/piyush_uwas.webp"
...
Thank you to UWAS for hosting and to the students and emerging professionals who contributed to an impactful event.